            ...
            <Grid container>
              ...
              <Grid item xs={12} md={5}>
                <Box sx={{ p: 1 }}>
                  ...
                  Nuwantha Enterprices is a company based in Sri Lanka which provides
                    travelling services to Sri Lankan people. The company started
                    in 2010 by providing services in 4 regions, as of 2022 the
                    company has already covered more than two third of the
                    country and provided more than 300 employments.
                  </Typography>
                </Box>
              </Grid>
            </Grid>
                    ...
                    <Grid item xs={12} md={6}>
                      <Row>
                        <ul>
                          ...
                          <li>
                            <Typography variant="h6">Kandy</Typography>
                          </li>
                          <li>
                            <Typography variant="h6">Jaffna</Typography>
                          </li>
                          <li>
                            <Typography variant="h6">Galle</Typography>
                          </li>
                  ...
                  <Grid container rowSpacing={7} sx={{ mt: { xs: 7, md: 11 } }}>
                    <Grid item xs={12} sm={6} md={4}>
                      <motion.div whileHover={{ scale: 1.5 }}>
                        ...
                        <Box mt={0.5}>
                          <center>
                            <Typography variant="h6">Amali Adhikari</Typography>
                            <Typography
                              className="text-primary"
                              sx={{ fontWeight: "bold" }}
                            >
                    ...
                    <Grid item xs={12} sm={6} md={4}>
                      <motion.div whileHover={{ scale: 1.5 }}>
                        ...
                        <Box mt={0.5}>
                          <center>
                            <Typography variant="h6">Ruwan Disanayake</Typography>
                            <Typography
                              className="text-primary"
                              sx={{ fontWeight: "bold" }}
                            >
                    ...
                    <ListItemText
                      ...
                      secondary={
                        <React.Fragment>
                          ...
                          {
                            " my journey with Nuwantha Enterprices is by far the best i ever had"
                          }
                        </React.Fragment>
                      }
                    />
              ...
              <Grid item xs={12} sm={6} md={4}>
                ...
                >
                  <ListItem alignItems="flex-start">
                    ...
                    <ListItemText
                      primary="Its Nuwantha Enterprices or nothing"
                      secondary={
                        <React.Fragment>
                          <Typography
                            sx={{ display: "inline", fontWeight: "bold" }}
                          ...
                          {" — Nuwantha Enterprices is the best out there honestly"}
                        </React.Fragment>
                      }
                    />
                  </ListItem>
                    ...
                    <ListItemText
                      ...
                      secondary={
                        <React.Fragment>
                          ...
                          {" — My journey with Nuwantha Enterprices was simply the best"}
                        </React.Fragment>
                      }
                    />
                  </ListItem>
                    ...
                    <ListItemText
                      ...
                      secondary={
                        <React.Fragment>
                          ...
                          {
                            " — I enjoyed every single minute of my journey with Nuwantha Enterprices"
                          }
                        </React.Fragment>
                      }
                    />
